...
-- 사용자 계정 생성
CREATE USER member_yjy IDENTIFIED BY member1234;

-- 생성한 사용자 계정에 권한 부여
GRANT CONNECT, RESOURCE, CREATE VIEW TO member_yjy;

-- 테이블 스페이스 할당
ALTER USER member_yjy DEFAULT
...
-- 게시판 테이블
CREATE TABLE "BOARD"(
	BOARD_NO NUMBER CONSTRAINT BOAR_PK PRIMARY KEY,
	BOARD_TITLE VARCHAR2(500) NOT NULL,
	BOARD_CONTENT VARCHAR2(4000) NOT NULL,
	CREATE_DT DATE DEFAULT SYSDATE,
	READ_COUNT NUMBER DEFAULT 0,
	DELETE_FL CHAR(1) DEFAULT 'N' CHECK( DELETE_FL IN ('N', 'Y') ),
	MRMBER_NO NUMBER CONSTRAINT BOARD_WRITER_FK REFERENCES "MEMBER"
...
COMMENT ON COLUMN "BOARD".MRMBER_NO IS '작성자 회원번호';
...
VALUES(SEQ_BOARD_NO.NEXTVAL, '샘플 제목 1', '샘플 내용 1 입니다.',
		TO_DATE('2022-09-20 10:20:12', 'YYYY-MM-DD HH24:MI:SS'),
		DEFAULT, DEFAULT, 2);

INSERT INTO BOARD
VALUES(SEQ_BOARD_NO.NEXTVAL, '샘플 제목 2', '샘플 내용 2 입니다.',
		TO_DATE('2022-09-21 10:17:12', 'YYYY-MM-DD HH24:MI:SS'),
		DEFAULT, DEFAULT, 2);
...
INSERT INTO "COMMENT" 
VALUES(SEQ_COMMENT_NO.NEXTVAL, '댓글 샘플 1번', DEFAULT, DEFAULT, 2, 3 );
															-- 회원번호, 게시글번호
INSERT INTO "COMMENT" 
VALUES(SEQ_COMMENT_NO.NEXTVAL, '댓글 샘플 2번', DEFAULT, DEFAULT, 2, 3 );

INSERT INTO "COMMENT" 
VALUES(SEQ_COMMENT_NO.NEXTVAL, '댓글 샘플 3번', DEFAULT, DEFAULT, 2, 3 );


COMMIT;


-- 게시글 목록 상세 조회(댓글 달 수 퐇마)
SELECT BOARD_NO, BOARD_TITLE, MEMBER_NM, READ_COUNT, CREATE_DT
	(SELECT ) COMMENT_COUNT
	
FROM "BOARD"
JOIN "MEMBER" ON(MEMBER_NO=MRMBER_NO)
WHERE DELETE_FL = 'N'
