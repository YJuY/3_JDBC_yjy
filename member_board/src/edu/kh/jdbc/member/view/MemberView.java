...
//		int input = -1; // 필드로 이동
	...
	private void selectMyInfo() {
		...
		System.out.println("아이이 : " 	+ loginMember.getMemberId());
...
//					
//					System.out.println(mem.getMemberId()+"    "+ mem.getMemberName()+"     "+mem.getMemberGender());
//
//				}
			}
	...
	private void updateMember() {
		try {
			...
			// 회원 정보 수정 서비스 메서드 호출 후 결과 변환 받기
