...
//alt+shift+->o
	...
	// 매개변수 11개짜리 생성자
	public Employee(int empId, String empName, String empNo, String email, String phone, int salary, 
					String deptcode, String jobcode, String salLevel, double bonus, int managerId) {
		super();
		this.empId = empId;
		this.empName = empName;
		this.empNo = empNo;
